...
<head>
    ...
    <link href="<?php echo base_url(); ?>asset/css/paginator.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>asset/css/font-awesome.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>asset/css/bootflat.min.css" rel="stylesheet">
     <link rel="stylesheet" href="<?php echo base_url(); ?>asset/css/jquery-ui-1.10.4.custom.min.css" />
     <script src="<?php echo base_url(); ?>asset/js/jquery.min.js"></script>
    
  	<script src="<?php echo base_url(); ?>asset/js/jquery-ui-1.10.4.custom.min.js"></script>
    <script src="<?php echo base_url(); ?>asset/js/bootstrap.min.js"></script>
    <script src="<?php echo base_url(); ?>asset/js/iCheck/icheck.js"></script>
     
    
    
    <!-- SB Admin CSS - Include with every page -->
    <link href="<?php echo base_url(); ?>asset/css/sb-admin.css" rel="stylesheet">
    <link href="<?php echo base_url(); ?>asset/css/template.css" rel="stylesheet">
            ...
            <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-cog"></span>&nbsp;กำหนดค่า</a>
             ...
             <li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-usd"></span>&nbsp;บัญชี</a>
              <ul class="dropdown-menu">
                ...
                <li class="dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-database"></i>&nbsp;ฐานข้อมูล</a>
              	<ul class="dropdown-menu">
                	<li><a href="<?php echo base_url(); ?>AC/ac_chart"><i class="fa fa-sitemap"></i>&nbsp; แก้ไขผังบัญชี</a></li>
                </ul>
               </li>
              </ul>
            </li>
