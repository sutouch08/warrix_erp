<div class="tab-pane fade" id="bookcode">
    ...
    <div class="row">
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control input-sm input-small bookcode" name="BOOK_CODE_ORDER" value="<?php echo $BOOK_CODE_ORDER; ?>" />
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control input-sm input-small bookcode" name="BOOK_CODE_SUPPORT" value="<?php echo $BOOK_CODE_SUPPORT; ?>" />
        <span class="help-block">กำหนดรหัสเล่มเอกสาร "ใบสั่งขาย"</span>
      </div>
      <div class="divider-hidden"></div>
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control input-sm input-small bookcode" name="BOOK_CODE_SPONSOR" value="<?php echo $BOOK_CODE_SPONSOR; ?>" />
        <span class="help-block">กำหนดรหัสเล่มเอกสาร "ใบสั่งขาย"</span>
      </div>
      <div class="divider-hidden"></div>
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control input-sm input-small bookcode" name="BOOK_CODE_BI" value="<?php echo $BOOK_CODE_RECEIVE_PO; ?>" />
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control input-sm input-small bookcode" name="BOOK_CODE_TRANSFER" value="<?php echo $BOOK_CODE_TRANSFER; ?>" />
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control input-sm input-small bookcode" name="BOOK_CODE_LEND" value="<?php echo $BOOK_CODE_LEND; ?>" />
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control input-sm input-small bookcode" name="BOOK_CODE_CONSIGN_TR" value="<?php echo $BOOK_CODE_CONSIGN_TR; ?>" />
        <span class="help-block">กำหนดรหัสเล่มเอกสาร "ใบโอนสินค้า"</span>
      </div>
      <div class="divider-hidden"></div>
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control input-sm input-small bookcode" name="BOOK_CODE_CONSIGN_SO" value="<?php echo $BOOK_CODE_CONSIGN_SO; ?>" />
        <span class="help-block">กำหนดรหัสเล่มเอกสาร "ใบโอนสินค้า"</span>
      </div>
      <div class="divider-hidden"></div>
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control input-sm input-small bookcode" name="BOOK_CODE_CONSIGN_SOLD" value="<?php echo $BOOK_CODE_CONSIGN_SOLD; ?>" />
        <span class="help-block">กำหนดรหัสเล่มเอกสาร "ใบสั่งขาย"</span>
      </div>
      <div class="divider-hidden"></div>
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control input-sm input-small bookcode" name="BOOK_CODE_TRANSFORM" value="<?php echo $BOOK_CODE_TRANSFORM; ?>" />
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control input-sm input-small bookcode" name="BOOK_CODE_TRANSFORM_STOCK" value="<?php echo $BOOK_CODE_TRANSFORM_STOCK; ?>" />
        <span class="help-block">กำหนดรหัสเล่มเอกสาร "ใบเบิกแปรสภาพ"</span>
      </div>
      <div class="divider-hidden"></div>
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control input-sm input-small bookcode" name="BOOK_CODE_RECEIVE_TRANSFORM" value="<?php echo $BOOK_CODE_RECEIVE_TRANSFORM; ?>" />
      ...
      <div class="col-sm-8">
        <input type="text" class="form-control input-sm input-small" name="BOOK_CODE_RETURN_ORDER" value="<?php echo $BOOK_CODE_RETURN_ORDER; ?>" />
